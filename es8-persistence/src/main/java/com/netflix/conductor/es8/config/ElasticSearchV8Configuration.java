...
public class ElasticSearchV8Configuration {
    ...
    /**
     * 用 RestClient + JacksonJsonpMapper 建立 ES8 Java Native Client。
     */
    @Bean
    ...
    public IndexDAO es8IndexDAO(
        ...
        // 這裡改成把 ElasticsearchClient 傳進 DAO，而不是 RestClientBuilder
        return new ElasticSearchRestDAOV8(
                elasticsearchClient, retryTemplate, properties, objectMapper);
    }
